...
import static dev.stratospheric.cdk.Network.getOutputParametersFromParameterStore;
...
public class ServiceApp {
    public static void main(final String[] args) {
        ...
        ServiceInputParameters serviceInputParameters = new ServiceInputParameters(
                dockerImageSource, environmentVariables(springProfile)).withHealthCheckIntervalSeconds(30);
